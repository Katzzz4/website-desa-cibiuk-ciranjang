        ...
        <nav class="flex-1 px-3 py-4 overflow-y-auto text-sm">
            @php
                ...
                $ikon = [
                    ...
                    'lapisan'    => 'M9 20.25l-5.447-2.724A1.125 1.125 0 013 16.518V4.982c0-.836.88-1.38 1.628-1.006L9 6.75m0 13.5l6-3m-6 3V6.75m6 10.5l4.372 2.186c.749.374 1.628-.169 1.628-1.005V7.894c0-.427-.24-.817-.622-1.007L15 4.5m0 12.75V4.5m-6 2.25l6-2.25',
                ...
                if (in_array(auth()->user()->role, ['superadmin', 'admin'], true)) {
                    ...
                    $grup[] = [
                        ...
                        'menu' => [
                            ...
                            ['Lapisan Peta', route('admin.peta-layer.index'), 'admin.peta-layer.*', $ikon['lapisan']],
                        ],
                    ];
                }
